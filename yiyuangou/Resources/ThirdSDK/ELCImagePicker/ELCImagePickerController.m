...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
        NSString *titlePrefix = [NSString stringWithFormat:NSLocalizedString(@"selectInfoPrefix", nil)];
        NSString *ttileSubfix = [NSString stringWithFormat:NSLocalizedString(@"selectInfo", nil)];
        NSString  *title = [NSString stringWithFormat:@"%@%ld%@",titlePrefix,self.maximumImagesCount,ttileSubfix];
