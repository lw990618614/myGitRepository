#line 1 "/Users/apple/Desktop/第二阶段/Douyin/DouyinDylib/Logos/DouyinDylib.xm"
...
@class UMANOpenUDID; @class BDASandBoxHelper; @class TTHttpRequestChromium; @class NSKeyedArchiver; @class TTAdSplashStore; @class TTInstallKeychain; @class TTAdSplashDeviceHelper; @class UIApplication; @class TTInstallUtil; @class BDLogDeviceHelper; @class CLSBetaController; @class CLSReportsController; @class BDLogSandBoxHelper; @class TTExtensions; @class IESAntiSpam; @class BDLogOpenUDID; @class BDADeviceHelper; @class BDUGGetMobileSandBoxHelper; @class CLSCrashReportingController; @class UMANProtocolData; @class UIDevice; @class TTInstallOpenUDID; @class TTTrackerProxy; @class Answers; @class TTInstallSandBoxHelper; @class UMANUtil; @class UTDIDOpenUDID; @class TTChannelRequestParam; @class TTNetworkManagerChromium; @class OpenUDID; @class TTInstallIDManager; @class AdMobKit; @class AWENetworkService; @class IESLiveDeviceInfo; @class IESGurdPackagesConfigResponse; @class TTInstallDeviceHelper; @class SGMDataAcquisitionUnit; @class HTSNHProjectInfo; @class FABSettings; @class Crashlytics; @class ASIdentifierManager; @class FABKit; @class NSKeyedUnarchiver; @class AWETrackerProjectInfo; 
...
#line 46 "/Users/apple/Desktop/第二阶段/Douyin/DouyinDylib/Logos/DouyinDylib.xm"
...
#line 1188 "/Users/apple/Desktop/第二阶段/Douyin/DouyinDylib/Logos/DouyinDylib.xm"
