...
@interface MySqliteModel : NSObject
...
@property (nonatomic, copy) NSString * changeIndex;//系统游戏每次ID
...
@property (nonatomic, copy) NSString * currentGameType;//当前流水变动内类型
...
@property (nonatomic, copy) NSString * isTuoed;//是否当过拖
